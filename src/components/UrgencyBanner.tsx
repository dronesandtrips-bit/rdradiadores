...
const UrgencyBanner = () => (
  <div className="bg-urgency text-urgency-foreground py-2 px-4 text-center text-sm font-body z-50 relative">
    <div className="container mx-auto flex items-center justify-center gap-2 flex-wrap">
      ...
      <span>WhatsApp:</span>
      <a href="https://api.whatsapp.com/send?phone=5554999723827" target="_blank" rel="noopener noreferrer" className="font-bold underline hover:opacity-80 transition-opacity">(54) 99972 38 27</a>
    </div>
  </div>
);
