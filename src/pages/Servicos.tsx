...
const services = [
  {
    ...
    items: ["Diagnóstico visual e teste de pressão", "Reparo de vazamentos e trincas", "Substituição de tubos e colmeias", "Troca de tampas e conexões", "Teste final com garantia"],
  },
  {
    ...
    items: ["Volvo FH/FM/FMX", "Scania R/S/P/G", "Mercedes Actros/Axor/Atego", "Iveco Hi-Way/Stralis/Trakker", "DAF XF/XG", "MAN TGX/TGS", "Ford Cargo", "VW Constellation/Meteor"],
  },
  {
    ...
    items: ["Limpeza química e mecânica", "Descarbonização interna e externa", "Troca do líquido de arrefecimento", "Inspeção de mangueiras e tampas", "Verificação da ventoinha"],
  },
  {
    ...
    items: ["Perda de potência", "Consumo excessivo de combustível", "Fumaça excessiva", "Motor engasgando na aceleração"],
  },
  {
  ...
  },
  {
    ...
    items: ["Inspeção visual completa", "Teste de pressão", "Verificação da temperatura", "Análise do líquido", "Verificação da bomba d'água e termostato", "Emissão de laudo"],
  },
];
        ...
        <div className="container mx-auto text-center">
          <AnimatedSection>
            ...
            <p className="text-secondary-foreground/70 max-w-2xl mx-auto font-body text-lg">
              Conserto de radiadores, limpeza do sistema de arrefecimento, reparo de intercooler e venda de radiadores para caminhões em Caxias do Sul - RS.
            </p>
          </AnimatedSection>
        </div>
      </section>
            ...
            <div className={`grid grid-cols-1 lg:grid-cols-2 gap-10 items-center ${i % 2 !== 0 ? "lg:flex-row-reverse" : ""}`}>
              <AnimatedSection direction={i % 2 === 0 ? "left" : "right"} className={i % 2 !== 0 ? "lg:order-2" : ""}>
                <div className="relative rounded-lg overflow-hidden shadow-xl group">
                  <img src={s.image} alt={s.title} className="w-full h-72 lg:h-96 object-cover group-hover:scale-105 transition-transform duration-700" loading="lazy" />
              ...
              <AnimatedSection direction={i % 2 === 0 ? "right" : "left"} className={i % 2 !== 0 ? "lg:order-1" : ""}>
                <div className="industrial-border pl-6">
                  ...
                  <h2 className="font-heading text-2xl md:text-4xl font-black uppercase text-foreground mb-4">{s.title}</h2>
